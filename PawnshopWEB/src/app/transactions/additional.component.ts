...
export class AdditionalComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // console.log(new Date(this.additionalForm.controls.dateTransaction.value));
    this.additionalForm.valueChanges.subscribe(() => {
      let dt = new Date(new Date(this.additionalForm.controls.dateTransaction.value).setHours(0,0,0,0));
      let dg = new Date(
        new Date(this.additionalForm.controls.dateGranted.value).setHours(0,0,0,0) );
